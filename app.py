...
def make_output():
    ...
    complaintFrequencyScore1 = user_inp['company_1'] + ' complaint-frequency score: ' + str(round(1.0 * countCompany1 / (monthlyDolVol1 + countCompany1), 2))
    complaintFrequencyScore2 = user_inp['company_2'] + ' complaint-frequency score: ' + str(round(1.0 * countCompany2 / (monthlyDolVol2 + countCompany2), 2))
    complaintFrequencyScore3 = user_inp['company_3'] + ' complaint-frequency score: ' + str(round(1.0 * countCompany3 / (monthlyDolVol3 + countCompany3), 2))
