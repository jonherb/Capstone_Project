...
def make_output():
    ...
    issuesPlot = Bar(df, 'issue', ylabel = 'Complaint frequency', title = 'Frequency of Complaint Issues for ' + user_inp["product"] +   
                     ' Products by ' +  user_inp["company_name"], legend = False)
